...
const conditionMatchCases: [string, string | number | boolean, string | number, boolean][] = [
    ...
    [CONDITION_OPERATORS.IN, "foo, bar", "foo", true],
    [CONDITION_OPERATORS.IN, "foo", "foo", true],
    [CONDITION_OPERATORS.IN, "1,2,3,4", 1, true],
