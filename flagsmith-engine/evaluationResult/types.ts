 ...
 */
export type Conditions = (SegmentCondition | InSegmentCondition)[];
/**
 ...
 * Unique feature identifier.
 */
export type FeatureKey1 = string;
/**
 * Feature name.
 */
 ...
 */
export type Segments1 = SegmentResult[];
